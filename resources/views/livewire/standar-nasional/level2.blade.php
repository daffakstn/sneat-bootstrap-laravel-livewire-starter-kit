@section('title', __('Standar Nasional Level 2 - ' . $parent->standar))
...
<div class="row g-4">
    <div class="col-lg-12">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            ...
                            {{ $isEditMode ? __('Edit Standar Nasional Level 2') : __('Tambah Standar Nasional Level 2') }}
                        </h5>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            ...
                            {{ __('Konfirmasi Hapus Standar Nasional Level 2') }}
                        </h5>
                    </div>
                    <div class="modal-body">
        ...
        <!-- Standar Nasional Level 2 Table -->
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Daftar Standar Nasional Level 2 untuk : ') }} {{ $parent->standar }}</h5>
                <div class="d-flex gap-2">
                    <!-- Back Button -->
                    <a href="{{ route('standar-nasional') }}" class="btn btn-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left me-2" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                        </svg>{{ __('Kembali ke Level 1') }}
                    </a>
                    <!-- Search -->
                    ...
                    <button class="btn btn-primary" wire:click="create">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle me-2" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                        </svg>{{ __('Tambah Standar Nasional Level 2') }}
                    </button>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="{{ route('standar-nasional.level3', $standar->id) }}" class="btn btn-sm btn-info" title="{{ __('Sub Standar Level 3') }}">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            @else
                                                <p class="mb-0">{{ __('Belum ada standar nasional level 2 yang ditambahkan untuk standar ini') }}</p>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
